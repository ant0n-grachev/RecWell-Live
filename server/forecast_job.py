...
PEAK_WINDOW_HOURS = int(os.getenv("PEAK_WINDOW_HOURS", "2"))
PEAK_Z_THRESHOLD = float(os.getenv("PEAK_Z_THRESHOLD", "0.4"))
LOW_Z_THRESHOLD = float(os.getenv("LOW_Z_THRESHOLD", "0.4"))
SMOOTH_WINDOW = int(os.getenv("SMOOTH_WINDOW", "1"))
